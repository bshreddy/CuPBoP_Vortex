...
${LLVM_PREFIX}/bin/clang++ -O0 -g -std=c++11  ./$KERNEL_CU --sysroot=/ --target=x86_64-linux-gnu -L$CUDA_PATH/lib64 --gcc-install-dir=/usr/lib/gcc/x86_64-linux-gnu/13 --cuda-gpu-arch=sm_50 -lcudart_static -ldl -lrt -pthread -save-temps -v  || true
...
then
    ...
    LD_LIBRARY_PATH=../../build/runtime/threadPool:${VORTEX_PATH}/runtime:../../build/runtime:${LD_LIBRARY_PATH} ./host.out -H 1024 -w 1024 -b 16 > Batch_vortex_test1.log #>  host_out.dump
